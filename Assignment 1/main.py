...
def problem4():
    ...
    threshold = 0.15  # change threshold
    """
    We checked different values for the threshold to find out, which one had the best
    tradeoff between seeing the edges of the church and the bush in front of the church.
    If you choose a value of 0.2-0.25 it is easier to see the outline of the church, because
    there is less noise (bush). If you choose a value of 0.1-0.15 there is much more noise, but
    we can also see more edges of the church.
    We choose a value of 0.15. It makes more sense to have more edges (information) in the picture
    and then later apply an algorithm that gets rid of the noise/bush.
    """
